...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 23. Mai 2017 um 13:01
...
--
-- Daten für Tabelle `relation_user_structs`
--

INSERT INTO `relation_user_structs` (`userId`, `structId`) VALUES
(1, 1);
...
--
-- Daten für Tabelle `structs`
--

INSERT INTO `structs` (`id`, `name`, `text`) VALUES
(1, 'test1', '{\"nameFromJson\":\"test1\"}');
...
CREATE TABLE `user` (
  ...
  `mail` varchar(30) CHARACTER SET latin1 NOT NULL,
